...
function App() {
    ...
    return (
        <div className="bg-cyan-300 text-center min-h-screen max-w-[100vw] overflow-x-hidden flex flex-col items-center">
            ...
            {filterData.length <= 0 ? <h1 className="text-6xl mt-32">No item found</h1> : <AllCards data={filterData} />}
